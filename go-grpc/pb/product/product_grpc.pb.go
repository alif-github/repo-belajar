...
type ProductServiceClient interface {
	...
	DeleteProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *productServiceClient) DeleteProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type ProductServiceServer interface {
	...
	DeleteProduct(context.Context, *Product) (*Status, error)
...
func (UnimplementedProductServiceServer) DeleteProduct(context.Context, *Product) (*Status, error) {
